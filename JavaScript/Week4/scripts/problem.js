...
4.	Using a RegExp, extract the Area Code from the Phone Number field. All Phone Numbers are in one of two formats: "555-555-5555" or "5555555555". Change all phone numbers to (xxx) - xxx - xxxx format.
...
6.	After doing all of the above steps, create a new record with ID, Name, Area Code, Height In Inches and separate them with commas [.join()]
...
function normalizeHeight(height) {
  ...
  return `${Math.round(inches, 2)} inches`;
}
